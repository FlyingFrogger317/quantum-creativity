...
public class GeckoShovelItem extends ShovelItem implements GeoItem {
    private String MODID;
    private String ITEM_NAME;
    private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
    GeckoShovelItem(Tier tier, int dmg, float speed, Properties  properties, String modid, String name){
    ...
    public class GenericGeckoModel extends GeoModel<GeckoShovelItem> {
        @Override
        public ResourceLocation getModelResource(GeckoShovelItem genericGeckoItem) {
            return ResourceLocation.fromNamespaceAndPath(MODID,genericGeckoItem.getModelPath());
        }

        @Override
        public ResourceLocation getTextureResource(GeckoShovelItem genericGeckoItem) {
            return ResourceLocation.fromNamespaceAndPath(MODID,genericGeckoItem.getTexturePath());
        }

        @Override
        public ResourceLocation getAnimationResource(GeckoShovelItem genericGeckoItem) {
    ...
    public class GenericGeckoRenderer extends GeoItemRenderer<GeckoShovelItem> {
