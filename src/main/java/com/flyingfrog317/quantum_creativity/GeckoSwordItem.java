...
public class GeckoSwordItem extends SwordItem implements GeoItem {
    private final String MODID;
    private final String ITEM_NAME;
    private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
    GeckoSwordItem(Tier tier, int dmg, float speed, Item.Properties  properties, String modid, String name){
    ...
    public class GenericGeckoModel extends GeoModel<GeckoSwordItem> {
        @Override
        public ResourceLocation getModelResource(GeckoSwordItem genericGeckoItem) {
            return ResourceLocation.fromNamespaceAndPath(MODID,genericGeckoItem.getModelPath());
        }

        @Override
        public ResourceLocation getTextureResource(GeckoSwordItem genericGeckoItem) {
            return ResourceLocation.fromNamespaceAndPath(MODID,genericGeckoItem.getTexturePath());
        }

        @Override
        public ResourceLocation getAnimationResource(GeckoSwordItem genericGeckoItem) {
    ...
    public class GenericGeckoRenderer extends GeoItemRenderer<GeckoSwordItem> {
