...
public class GeckoHoeItem extends HoeItem implements GeoItem {
    private final String MODID;
    private final String ITEM_NAME;
    private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
    GeckoHoeItem(Tier tier, int dmg, float speed, Properties properties, String modid, String name){
    ...
    public class GenericGeckoModel extends GeoModel<GeckoHoeItem> {
        @Override
        public ResourceLocation getModelResource(GeckoHoeItem genericGeckoItem) {
            return ResourceLocation.fromNamespaceAndPath(MODID,genericGeckoItem.getModelPath());
        }

        @Override
        public ResourceLocation getTextureResource(GeckoHoeItem genericGeckoItem) {
            return ResourceLocation.fromNamespaceAndPath(MODID,genericGeckoItem.getTexturePath());
        }

        @Override
        public ResourceLocation getAnimationResource(GeckoHoeItem genericGeckoItem) {
    ...
    public class GenericGeckoRenderer extends GeoItemRenderer<GeckoHoeItem> {
